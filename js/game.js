...
new Vue({
    ...
    methods: {
        ...
        checkGameStatus() {
            if (this.playerWins()) {
                Swal.fire("¡Tú ganas! La palabra es " + this.getUnhiddenWord());
                this.resetGame();
            }
            if (this.playerLoses()) {
                Swal.fire("Has perdido. La palabra era " + this.getUnhiddenWord());
                this.resetGame();
            }
        },
        getUnhiddenWord() {
        ...
        async chooseWord() {
            ...
            if (!words.length) {
                await Swal.fire("Añade algunas palabras para que puedas jugar (ve a Agregar Palabra)");
